...
import styles from "./GmatCityHero.module.css";

interface GmatCityHeroProps {
  preTitle: string;
  title: string;
...
export default function GmatCityHero({
  preTitle,
  title,
  titleHighlight,
  subtitle,
    ...
    <section className={styles.hero}>
      <div className={styles.heroBackground}>
        <img
          ...
          alt={`GMAT Coaching in ${city} - MBA Wizards`}
      ...
      <div className={`container ${styles.content}`}>
        ...
        <div className={styles.actions}>
          ...
          <a
            href={`${siteConfig.whatsappUrl}%2C%20i%27m%20inquiring%20about%20GMAT%20coaching%20in%20${city}.`}
            target="_blank"
