...
import styles from "./GmatGreCityHero.module.css";

interface GmatGreCityHeroProps {
  preTitle: string;
  title: string;
...
export default function GmatGreCityHero({
  preTitle,
  title,
  titleHighlight,
  subtitle,
  city,
}: GmatGreCityHeroProps) {
  return (
    <section className={styles.hero}>
      <div className={styles.heroBackground}>
        <img
          src="/images/heroes/hero-gre.jpg"
          alt={`GMAT & GRE Coaching in ${city} - MBA Wizards`}
      ...
      <div className={`container ${styles.content}`}>
        ...
        <div className={styles.actions}>
          ...
          <a
            href={`${siteConfig.whatsappUrl}%2C%20i%27m%20inquiring%20about%20GMAT%2BGRE%20coaching%20in%20${city}.`}
            target="_blank"
